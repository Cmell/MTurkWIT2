  ...
  **/
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var end_trial = function() {
      ...
      jsPsych.pluginAPI.cancelKeyboardResponse(keyboardListener);
      if (typeof fbKeyboardListener != 'undefined') {
        jsPsych.pluginAPI.cancelKeyboardResponse(fbKeyboardListener);
      };
      ...
      var trial_data = {
        ...
        "feedback_shown": JSON.stringify(feedbackShown)
      };
      ...
      if (typeof rt === 'undefined' && response_in_window) {
        ...
        for (var j = 0; j < trial.choices.length; j++) {
          ...
          if (info.key == keycode) {
            ...
            if ((trial.response_ends_stimulus[whichStimulus] || trial.response_ends_trial) && !feedbackShown) {
              endStimulus();
            }
            break;
          }
