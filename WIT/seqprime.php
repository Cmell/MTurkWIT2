...
/*
  instr2 = <?php
  //TODO: What should the second instruction screen be?
  ...
  */
  ...
  // cross prime type and target type, recycle to the number of trials
  var crossedFactors = expandGrid([[0,1],[0,1]]); // in terms of indexes
  ...
  var target, prime, primeStim, targetStim, curMask;
